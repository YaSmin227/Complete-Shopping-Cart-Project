...
import { decreaseCart, addToCart, removeFromCart, clearCart, getTotalPrice } from '../features/cartSlice';

const Cart = () => {
  const { cartItems, TotalCartPrice } = useSelector((state) => state.cartItems);
          ...
          <div className="cart-summary">
            ...
            <div className="cart-checkout">
              <div className="subtotal">
                <span>Subtotal</span>
                  <span className="amount">{TotalCartPrice}</span>
              </div>
